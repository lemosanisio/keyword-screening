...
class IdempotencyService(
     ...
     */
    fun findExisting(transactionId: TransactionId, ruleCode: String): ScreeningResult? =
     ...
     */
    fun persist(transactionId: TransactionId, ruleCode: String, result: ScreeningResult): ScreeningResult {
