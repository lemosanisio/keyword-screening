CREATE TABLE suspicion_decision (
    ...
    CONSTRAINT uq_suspicion_decision_case_version UNIQUE (case_id, decision_version)
);

CREATE INDEX idx_suspicion_decision_case_decided_at ON suspicion_decision (case_id, decided_at);
